...
int binary(int arr[], int l, int r, int x, int y){
...
int main(){
    ...
    for(int i = 0; i < m; i++){
        ...
        cin >> l1 >> r1 >> l2 >> r2;
        if(l1 <=l2 && r2 <= r1){
            cout << binary(arr, -1, n, l1, r1) << endl;
        } else if(l2 <= l1 && r1 <= r2){
            cout << binary(arr, -1, n, l2, r2) << endl;
        } else if(l1 <= l2 && l2 <= r1){
            cout << binary(arr, -1, n, l1, r2) << endl;
        } else if(l2 <= l1 && l1 <= r2){
            cout << binary(arr, -1, n, l2, r1) << endl;
        } else{
            cout << binary(arr, -1, n, l1, r1) + binary(arr, -1, n, l2, r2) << endl;
        }
    }
    return 0;
}